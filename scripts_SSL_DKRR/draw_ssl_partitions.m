function draw_ssl_partitions(filepath)
    load(filepath);

    legend_str = {'Semi-supervised DKRR', 'Supervised DKRR', 'Nystr\"om', 'RF', 'FALKON'};
    xlabel_str = '$\#$ the number of partitions $m$';
    ...
    draw_plot_fig(m_set, Y, ['./results/', data_name, '_ssl_error_partitions.pdf'], legend_str, xlabel_str, ylabel_str);
    ...
    draw_plot_fig(m_set, Y, ['./results/', data_name, '_ssl_training_partitions.pdf'], legend_str, xlabel_str, ylabel_str);
end